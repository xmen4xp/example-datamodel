...
import (
	...
	v1 "example/build/client/listers/event.example.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EventExampleV1().Events().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventExampleV1().Events().Watch(context.TODO(), options)
			},
		},
		&eventexamplecomv1.Event{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventexamplecomv1.Event{}, f.defaultInformer)
}
