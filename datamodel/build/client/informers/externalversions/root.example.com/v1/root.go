...
import (
	...
	v1 "example/build/client/listers/root.example.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RootExampleV1().Roots().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RootExampleV1().Roots().Watch(context.TODO(), options)
			},
		},
		&rootexamplecomv1.Root{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *rootInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rootexamplecomv1.Root{}, f.defaultInformer)
}
