...
import (
	...
	v1 "example/build/client/listers/user.example.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.UserExampleV1().Users().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UserExampleV1().Users().Watch(context.TODO(), options)
			},
		},
		&userexamplecomv1.User{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&userexamplecomv1.User{}, f.defaultInformer)
}
