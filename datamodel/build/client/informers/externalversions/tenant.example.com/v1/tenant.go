...
import (
	...
	v1 "example/build/client/listers/tenant.example.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TenantExampleV1().Tenants().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TenantExampleV1().Tenants().Watch(context.TODO(), options)
			},
		},
		&tenantexamplecomv1.Tenant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tenantexamplecomv1.Tenant{}, f.defaultInformer)
}
