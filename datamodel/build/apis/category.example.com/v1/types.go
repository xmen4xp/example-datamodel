...
type Category struct {
	...
	Spec              CategorySpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            CategoryNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type CategoryNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *Category) CRDName() string {
	return "categories.category.example.com"
}
...
type CategorySpec struct {
	Desription string `json:"desription" yaml:"desription"`
}
...
type CategoryList struct {
	...
	Items           []Category `json:"items" yaml:"items"`
}
