...
type RuntimeUser struct {
	...
	Spec              RuntimeUserSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            RuntimeUserNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type RuntimeUserNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *RuntimeUser) CRDName() string {
	return "runtimeusers.runtimeuser.example.com"
}

func (c *RuntimeUser) DisplayName() string {
	if c.GetLabels() != nil {
...
type RuntimeUserSpec struct {
	...
	UserGvk       *Link  `json:"userGvk,omitempty" yaml:"userGvk,omitempty" nexus:"link"`
}
...
type RuntimeUserList struct {
	...
	Items           []RuntimeUser `json:"items" yaml:"items"`
}
