...
type Evaluation struct {
	...
	Spec              EvaluationSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            EvaluationNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type EvaluationNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *Evaluation) CRDName() string {
	return "evaluations.evaluation.example.com"
}

func (c *Evaluation) DisplayName() string {
	if c.GetLabels() != nil {
...
type EvaluationList struct {
	...
	Items           []Evaluation `json:"items" yaml:"items"`
}
