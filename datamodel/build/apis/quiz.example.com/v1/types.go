...
type Quiz struct {
	...
	Spec              QuizSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            QuizNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}
...
func (c *Quiz) CRDName() string {
	return "quizes.quiz.example.com"
}

func (c *Quiz) DisplayName() string {
	if c.GetLabels() != nil {
