...
type QuizChoice struct {
	...
	Spec              QuizChoiceSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            QuizChoiceNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type QuizChoiceNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *QuizChoice) CRDName() string {
	return "quizchoices.quizchoice.example.com"
}

func (c *QuizChoice) DisplayName() string {
	if c.GetLabels() != nil {
...
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
type QuizChoiceList struct {
	metav1.TypeMeta `json:",inline" yaml:",inline"`
	metav1.ListMeta `json:"metadata" yaml:"metadata"`
	Items           []QuizChoice `json:"items" yaml:"items"`
}
